        ...
        <Layout>
            ...
            <div id="shop-container">
                <div className="shop-card">
                    ...
                    <ul>
                        <li><p>A breakdown of traditional double tops and bottoms and what's wrong with them</p></li>
                        <li><p>Concrete rules for finding PTP High-Probability Doubles</p></li>
                        <li><p>Step-by step instructions on how to trade PTP High-Probability Doubles</p></li>
                    </ul>
                </div>
                <div className="shop-card">
                    <FaDesktop id="courses-icon" size="90" color="rgb(0, 183, 255)"/>
