    ...
    return (
        <Layout>
            <div id="about-main">
                ...
                <h3 className="about-headers">Who We Are</h3>
                ...
                <div className="headshot-container">
                    <div className="headshot-card">
                        ...
                        <h3 className="about-headers">Bob Iaccino</h3>
                    ...
                    <div className="headshot-card">
                        ...
                        <h3 className="about-headers">Mike Arnold</h3>
                ...
                <h3 className="about-headers">What We Offer</h3>
                    <div id="lower-container">
                        <div className="about-card">
                            <FaLaptop size="70" color="rgb(194, 225, 20)"/>
                        ...
                        <div className="about-card">
                            <GiTeacher size="70" color="rgb(194, 225, 20)"/>
