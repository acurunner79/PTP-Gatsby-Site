                    ...
                    <div id="lower-container">
                        <div className="about-card">
                            <a target="_blank" rel="noreferrer" href="https://path-trading-partners.teachable.com/">
                                <FaLaptop className="about-page-icon" size="70" color="white"/>
                                <h2 className="about-offer-header">Trader Training</h2>
                        ...
                        <div className="about-card">
                            {/* <a target="_blank" rel="noreferrer" href="https://path-trading-partners.teachable.com/"> */}
                            <Link to="/contact">
                                <GiTeacher className="about-page-icon" size="70" color="white"/>
                                <h2 className="about-offer-header">Personal Coaching</h2>
